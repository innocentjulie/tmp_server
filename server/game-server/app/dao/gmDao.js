...
{
    var sql = 'select * from gm where `account` = ?';
...
Dao.updateLoginTime = function(acc,logintime,cb)
{
    ...
    var sql = 'update gm set `logintime` = ? where  `account` = ?';
...
Dao.updateLoginOutTime = function(acc,outtime,cb)
{
    ...
    var sql = 'update gm set `loginouttime` = ? where  `account` = ?';
